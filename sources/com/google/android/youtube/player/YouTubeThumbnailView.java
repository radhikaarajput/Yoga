...
public final class YouTubeThumbnailView extends ImageView {
    ...
    private static final class a implements t.a, t.b {
        ...
        public a(YouTubeThumbnailView youTubeThumbnailView, OnInitializedListener onInitializedListener) {
            this.a = (YouTubeThumbnailView) ab.a(youTubeThumbnailView, (Object) "thumbnailView cannot be null");
            this.b = (OnInitializedListener) ab.a(onInitializedListener, (Object) "onInitializedlistener cannot be null");
        }

        private void c() {
            if (this.a != null) {
                b unused = this.a.a = null;
                this.a = null;
                this.b = null;
            }
        }
        ...
        public final void a() {
            if (this.a != null && this.a.a != null) {
                com.google.android.youtube.player.internal.a unused = this.a.b = aa.a().a(this.a.a, this.a);
