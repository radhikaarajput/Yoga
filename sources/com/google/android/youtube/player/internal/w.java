...
public final class w {
    ...
    private static IBinder a(Class<?> cls, IBinder iBinder, IBinder iBinder2, IBinder iBinder3, boolean z) throws a {
        try {
            ...
            throw new a(valueOf.length() != 0 ? "Could not find the right constructor for ".concat(valueOf) : new String("Could not find the right constructor for "), noSuchMethodException);
        } catch (InvocationTargetException e2) {
            InvocationTargetException invocationTargetException = e2;
            String valueOf2 = String.valueOf(cls.getName());
            throw new a(valueOf2.length() != 0 ? "Exception thrown by invoked constructor in ".concat(valueOf2) : new String("Exception thrown by invoked constructor in "), invocationTargetException);
        } catch (InstantiationException e3) {
            InstantiationException instantiationException = e3;
            String valueOf3 = String.valueOf(cls.getName());
            throw new a(valueOf3.length() != 0 ? "Unable to instantiate the dynamic class ".concat(valueOf3) : new String("Unable to instantiate the dynamic class "), instantiationException);
        } catch (IllegalAccessException e4) {
            IllegalAccessException illegalAccessException = e4;
            String valueOf4 = String.valueOf(cls.getName());
            throw new a(valueOf4.length() != 0 ? "Unable to call the default constructor of ".concat(valueOf4) : new String("Unable to call the default constructor of "), illegalAccessException);
        }
    }
    ...
    private static IBinder a(ClassLoader classLoader, String str, IBinder iBinder, IBinder iBinder2, IBinder iBinder3, boolean z) throws a {
        try {
            ...
            throw new a(valueOf.length() != 0 ? "Unable to find dynamic class ".concat(valueOf) : new String("Unable to find dynamic class "), classNotFoundException);
        }
    }
